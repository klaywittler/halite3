...
while True:
    ...
    if game.turn_number <= 0.5*constants.MAX_TURNS and me.halite_amount >= constants.SHIP_COST and not game_map[me.shipyard].is_occupied or len(me.get_ships()) == 0 and me.halite_amount >= constants.SHIP_COST:
